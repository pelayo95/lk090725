    ...
    return (
        <div className="space-y-6">
            ...
            <div className="md:flex md:gap-8 items-start">
                <aside className="md:w-20 hover:md:w-64 transition-all duration-300 ease-in-out mb-6 md:mb-0 md:flex-shrink-0 group overflow-hidden">
                    <div className="space-y-6">
                        {visibleCategories.map(category => (
                            <div key={category.name}>
                                <h3 className="px-3 mb-2 text-xs font-semibold text-slate-500 uppercase tracking-wider flex items-center gap-2">
                                    {category.icon}
                                    <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">{category.name}</span>
                                </h3>
